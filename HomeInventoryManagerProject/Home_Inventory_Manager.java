	...
	y += dy;
	g2D.drawString("Price: $" + Home_Inventory_Manager.myInventory[i].purchasePrice + ",Purchased on: " + Home_Inventory_Manager.myInventory[i].purchaseDate, (int) (pf.getImageableX() +25), y);
	y += dy;
    ...
    JButton newButton = new JButton(new ImageIcon("C:\\Users\\Kunal\\Desktop\\Become Java Devloper\\FreeIconWebsite\\new.png"));
    JButton deleteButton = new JButton(new ImageIcon("C:\\Users\\Kunal\\Desktop\\Become Java Devloper\\FreeIconWebsite\\delete.png"));
    JButton saveButton = new JButton(new ImageIcon("C:\\Users\\Kunal\\Desktop\\Become Java Devloper\\FreeIconWebsite\\save.png"));
    JButton previousButton = new JButton(new ImageIcon("C:\\Users\\Kunal\\Desktop\\Become Java Devloper\\FreeIconWebsite\\previous.png"));
    JButton nextButton = new JButton(new ImageIcon("C:\\Users\\Kunal\\Desktop\\Become Java Devloper\\FreeIconWebsite\\next.png"));
    JButton printButton = new JButton(new ImageIcon("C:\\Users\\Kunal\\Desktop\\Become Java Devloper\\FreeIconWebsite\\print.png"));
    JButton exitButton = new JButton(new ImageIcon("C:\\Users\\Kunal\\Desktop\\Become Java Devloper\\FreeIconWebsite\\exit.png"));
    JButton photoButton = new JButton();
    JButton[] searchButton = new JButton[26];
